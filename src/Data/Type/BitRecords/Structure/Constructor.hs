...
type instance Constructor (Assign s a) next = WithValidLiteralSize s a next
...
_constructorSpec =
     (undefined :: Constructor U8 ()) (undefined :: Word8)
          ...
          <> (undefined :: Constructor (S 16 'BE) ())
                  (undefined :: IntegerStructure 16 'Signed 'BE 'MkStructure)
          ...
          <> (undefined :: Constructor (S 16 'LE) ())
                  (undefined :: IntegerStructure 16 'Signed 'LE 'MkStructure)
          ...
          <> (undefined :: Constructor (S 32 'BE) ())
                  (undefined :: IntegerStructure 32 'Signed 'BE 'MkStructure)
          ...
          <> (undefined :: Constructor (S 32 'LE) ())
                  (undefined :: IntegerStructure 32 'Signed 'LE 'MkStructure)
          ...
          <> (undefined :: Constructor (S 64 'BE) ())
                  (undefined :: IntegerStructure 64 'Signed 'BE 'MkStructure)
          ...
          <> (undefined :: Constructor (S 64 'LE) ())
                  (undefined :: IntegerStructure 64 'Signed 'LE 'MkStructure)
          ...
          <> (undefined :: Constructor
                  ...
                  (undefined :: Word8)
          <> (undefined :: Constructor (Record '[Name "x" U8, Name "y" S8]) ())
                  (undefined :: Word8)
                  (undefined :: Int8)
          <> (undefined :: Constructor
